...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #c2e0f4;color: #000000">
  <table id="u_body" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: whitesmoke;width:100%" cellpadding="0" cellspacing="0">
    <tbody>
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                    <img align="center" border="0" src = "{{asset('assets/images/logo.png')}}" alt="Logo" title="Première site pour les Annonces Immobilières"  width="174" class="v-src-width v-src-max-width" 
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="{{asset('assets/images/image-2.jpeg')}}" alt="Banner" title="Banner"
                              ...
                              <div class="v-text-align v-font-size"
                                ...
                                <p style="font-size: 14px; line-height: 180%;"><span
                                    style="font-size: 18px; line-height: 32.4px; font-family: Lato, sans-serif;"><strong><span
                                        style="line-height: 32.4px; font-size: 18px;">Bienvenue {{$nomComplet}} ,
                                      </span></strong></span></p>
                                <p style="font-size: 14px; line-height: 180%;">&nbsp;</p>
                                <p style="font-size: 14px; line-height: 180%; text-align:justify;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;">
                                    Nous sommes ravis de vous accueillir sur EXPERTIMMO ! Pour finaliser votre inscription et profiter pleinement de tous nos services, <br>
                                    Veuillez confirmer votre adresse e-mail en cliquant sur le lien <br>
                                    ci-dessous :</span></p>
                              </div>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-text-align" align="center">
                                ...
                                <a href="{{$verificationLink}}" target="_blank" class="v-button v-font-size"
                                  ...
                                  <span style="display:block;padding:20px 70px;line-height:120%;"><strong><span
                                        ...
                                        V É R I F I E R &nbsp; &nbsp;V O T R E &nbsp; &nbsp; C O M P T E</span></strong></span>
                                </a>
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-text-align v-font-size"
                                ...
                                <p style="font-size: 14px; line-height: 170%;"><span
                                    style="font-family: Lato, sans-serif; font-size: 16px; line-height: 27.2px;">
                                    ...
                                    Cordialement, L'équipe EXPERTDEALS</span>
                                </span></p>
                              </div>
                          ...
                          <tr>
                            <td class="v-container-padding-padding"
                              ...
                              <h1 class="v-text-align v-font-size"
                                ...
                                Téléphone: <strong>123-456-7890</strong></h1>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                            ...
                            <td class="v-container-padding-padding"
                              ...
                              <div class="v-text-align v-font-size"
                                ...
                                <p style="font-size: 14px; line-height: 210%;"><span
                                    style="font-family: Lato, sans-serif; font-size: 14px; line-height: 29.4px;">&copy;
                                    EXPERTDEALS </span></p>
                              </div>
